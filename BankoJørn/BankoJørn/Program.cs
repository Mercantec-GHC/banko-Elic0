...
class Program
{
    static void Main()
    {
        int[] card1Row1 = { 11, 30, 43, 61, 73 };
        int[] card1Row2 = { 8, 26, 32, 75, 86 };
        int[] card1Row3 = { 39, 56, 66, 77, 89 };
        string card1 = "Jørn";

        int[] card2Row1 = { 11, 47, 56, 60, 84 };
        int[] card2Row2 = { 6, 13, 38, 57, 87 };
        int[] card2Row3 = { 29, 39, 49, 79, 89 };
        string card2 = "Jørn";

        int[] card3Row1 = { 15, 22, 45, 61, 73 };
        int[] card3Row2 = { 3, 34, 47, 68, 85 };
        int[] card3Row3 = { 5, 19, 37, 59, 69 };
        string card3 = "Jørn";
